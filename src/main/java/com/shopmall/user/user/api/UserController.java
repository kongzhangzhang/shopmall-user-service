...
import com.shopmall.user.common.utils.*;
import com.shopmall.user.common.utils.*;
import com.shopmall.user.core.model.UserModel;
import com.shopmall.user.security.constants.SecurityConstant;
...
import com.shopmall.user.common.tools.RedisCache;
import com.shopmall.user.security.api.TokenController;
import com.shopmall.user.security.security.AuthenticationRequest;
import com.shopmall.user.security.security.CoolplayUserCache;
import com.shopmall.user.security.security.HttpAuthenticationDetails;
import com.shopmall.user.security.service.IUserService;
import com.shopmall.user.security.utils.TokenUtils;
import com.shopmall.user.user.model.UserPassMappingModel;
import com.shopmall.user.user.service.IUserPassMappingService;
...
public class UserController {
    ...
    public Result login(HttpServletRequest request,
        ...
        try {
            UserModel userModel = userService.findUserByMobilePhone(authenticationRequest.getContactPhone());
            if (userModel == null) {
    ...
    public ResponseEntity<?> loginByVerifyCode(HttpServletRequest request,
        ...
        try {
            ...
            if (StringUtils.isNotEmpty((String) redisCache
                    .get(SecurityConstant.MOBILE_VERIFY_CODE_PREFIX + authenticationRequest.getContactPhone()))) {
                if (!((String) redisCache
                        .get(SecurityConstant.MOBILE_VERIFY_CODE_PREFIX + authenticationRequest.getContactPhone()))
                        .equals(authenticationRequest.getVerifyCode())) {
    ...
    public ResponseEntity<?> loginByWechat(HttpServletRequest request,
        ...
        try {
            ...
            if (userModel == null) {
                ...
                userModel.setContactPhone(uuid);
    ...
    public Result register(HttpServletRequest request, @RequestBody UserModel userModel) {
        ...
        try {
            ...
            if (StringUtils
                    .isNotEmpty((String) redisCache.get(SecurityConstant.MOBILE_VERIFY_CODE_PREFIX + userModel.getContactPhone()))) {
                if (!((String) redisCache.get(SecurityConstant.MOBILE_VERIFY_CODE_PREFIX + userModel.getContactPhone()))
            ...
            UserModel userInfo = userService.findUserByMobilePhone(userModel.getContactPhone());
            if (userInfo != null) {
            ...
            userModel.setPassword(passwordEncode);
            userModel.setUserName(userModel.getContactPhone());
            userModel.setAccountNonLocked(true);
            userModel.setAccountNonExpired(true);
            userModel.setCredentialsNonExpired(true);
            userModel.setEnabled(true);
    ...
    public Result adjustUserInfo(@RequestBody UserModel userModel) {
        ...
        try {
            ...
            UserModel validateUserModel = userService.findUserByMobilePhone(userModel.getContactPhone());
    ...
    public Result accountList(@RequestBody UserModel userModel) {
    ...
    public Result accountDetail(@RequestBody QueryDto queryDto) {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/addGoldMember", method = RequestMethod.POST)
    public Result addGoldMember(@RequestBody UserModel userModel) {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/cancelGoldMember", method = RequestMethod.POST)
    public Result cancelGoldMember(@RequestBody UserModel userModel) {
